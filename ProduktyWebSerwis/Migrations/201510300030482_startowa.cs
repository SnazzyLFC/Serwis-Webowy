    ...
    public partial class startowa : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Produkt_Id, t.Allergen_Id })
                .ForeignKey("dbo.Produkt", t => t.Produkt_Id, cascadeDelete: true)
                .ForeignKey("dbo.Allergen", t => t.Allergen_Id, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Allergen", "Kategoria_Id", "dbo.Kategoria");
            DropForeignKey("dbo.Produkt", "Kategoria_Id", "dbo.Kategoria");
            DropForeignKey("dbo.ProduktAllergen", "Allergen_Id", "dbo.Allergen");
            DropForeignKey("dbo.ProduktAllergen", "Produkt_Id", "dbo.Produkt");
            DropIndex("dbo.ProduktAllergen", new[] { "Allergen_Id" });
            DropIndex("dbo.ProduktAllergen", new[] { "Produkt_Id" });
            ...
            DropIndex("dbo.Allergen", new[] { "Kategoria_Id" });
            DropTable("dbo.ProduktAllergen");
